...
public class PlaceInfo {
    ...
    public PlaceInfo(double latitue, double longitude, String address, String city, String state, String country, String postalCode, String knownName, String countryCode)
    {
